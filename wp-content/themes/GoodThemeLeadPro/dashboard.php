...
array("name" => "About me Image",
            ...
            "id" => $shortname."_img",
            "std" => "http://goodtheme.org/images/meee.gif",
            "type" => "text"),    
...
array(	"name" => "Banner Ad Header - Image Location",
					...
					"std" => "http://goodtheme.org/images/gt-ad-468x60.gif",
					"type" => "text"),
...
array(	"name" => "Disable Ad",
	...
	array("name" => "Banner-1 Image",
            ...
            "std" => "http://goodtheme.org/images/gt-ad-125x125.gif",
            "type" => "text"),     
	...
	array("name" => "Banner-2 Image",
            ...
            "std" => "http://goodtheme.org/images/gt-ad2-125x125.gif",
            "type" => "text"),    
	...
	array("name" => "Banner-3 Image",
            ...
            "std" => "http://goodtheme.org/images/gt-ad3-125x125.gif",
            "type" => "text"),    
...
<p>Visit us: <a href="http://goodtheme.org/" >GoodTheme.org</a>. </p>
<?php
}
